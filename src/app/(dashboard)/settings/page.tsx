        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-3 gap-3">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Default Parts Markup (%)</label>
                <input type="number" value={form.defaultMarkup ?? 30} onChange={set('defaultMarkup')} min={0} max={300}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                <p className="text-xs text-gray-400 mt-1">Auto-fills when adding parts</p>
              </div>
              <div>
